...
def single_extract(in_fldr, fl_n, out_fldr, emb_model, openface_path):
...
def folder_extract(in_fldr, out_fldr, openface_path, fabnet_path, njobs=10):
    ...
    i = 0
    for v in vid_files:
        full_struct[i] = (in_fldr, v.split('.')[0], out_fldr, emb_model, openface_path)
        i = i+1
