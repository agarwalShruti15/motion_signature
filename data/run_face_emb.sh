...
python -W ignore extract_fabnet.py --bsfldr '/data/home/shruti/voxceleb/videos/vox2_mp4/dev/mp4' --ofd '/data/home/shruti/voxceleb/fabnet/vox2_mp4' --njobs 30 --openface 'OpenFace-master/build/bin' --fnmodel 'release/nv2_curriculum.pth'
